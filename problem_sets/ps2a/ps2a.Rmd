...
Yes. In a particularly bad case, attrition from the panel may be related to the
dependent variable and we might get selection bias. However, even with
completely ignorable attrition, we still need to adjust
