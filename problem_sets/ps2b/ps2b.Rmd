...
stargazer(reg_1c,
          title = "Event Study Regression with Threshold Indicators\\label{tab:event-study-remove-controls}",
          dep.var.caption = "Log(Fatality per Population)",
          dep.var.labels.include = FALSE,
...
stargazer(reg_1b, reg_1b2, reg_1c, reg_1c2,
          title = "Event Study Regressions without Pure Control States\\label{tab:event-study-no-controls}",
          dep.var.caption = "Log(Fatality per Population)",
          dep.var.labels.include = FALSE,
...
Table \\ref{tab:event-study-remove-controls} that for event-time indicators
...
\\ref{tab:event-study-remove-controls}.

If we focus on columns (3) and (4) from Table
\\ref{tab:event-study-remove-controls}, we can see removing the pure control
