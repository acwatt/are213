...
treat_val = (data2 %>% 
    filter(year == tail(preperiod_years$year, n=1),
           state == 99))$ln_fat_pc
...
```{r Compare other vars fro 47 and 99, message=F}
...
dataprep.out <-
    dataprep(foo = data,
             predictors = c("secondary" , "college" , "beer" ,
                            "unemploy" , "ln_tvmt_pc" , "ln_precip", "snow32",
                            "ln_rspeed", "ln_uspeed"),
...
# primary, college, beer, secondary, unemploy, ln_tvmt_pc, ln_precip, snow32, ln_rspeed, ln_uspeed
```
